...
def transform_nasa_record(record: Dict[str, Any]) -> Dict[str, Any]:
    ...
    transformed = {
        'model_id': model_id,
        'model_name': 'NASA_GFMS_Flood_Model',
        'forecast_time': datetime.now().isoformat(),
        'grid_cell_latitude': lat,
        'grid_cell_longitude': lon,
        ...
        'spatial_extent_west': lon - 0.005 if lon else None,
        'spatial_extent_south': lat - 0.005 if lat else None,
        'spatial_extent_east': lon + 0.005 if lon else None,
        'spatial_extent_north': lat + 0.005 if lat else None,
        'source_file': 'nasa_flood_models.csv',
