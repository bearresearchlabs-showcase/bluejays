...
def main():
    ...
    report = {
        ...
        'summary': {
            ...
            'execution_testing_status': 'EXECUTED' if execution_results.get('postgresql', {}).get('queries') else 'PARTIAL'
        },
    ...
    if fix_verification.get('Pass', 1) == 0 or fix_verification.get('overall_status') == 'FAIL':
