#!/usr/bin/env python3
"""
Generate Large Dataset for db-2 Filling Station Retail (phppos schema).
Generates ~1 GB of phppos_sales, phppos_items, phppos_people, phppos_locations data.
"""
...
def main():
    ...
    # Seed: people, locations, items, employees
