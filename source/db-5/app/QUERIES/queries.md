...
```text
This database supports analytics for POS retail (Lucasa) operations. It models people,
employees, items, locations, inventory, and sales transactions. It is designed to support
text-to-SQL training across revenue, inventory, and workforce query types commonly
encountered in convenience store and retail point-of-sale analytics.
```
