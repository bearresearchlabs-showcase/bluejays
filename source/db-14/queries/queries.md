...
```json
{
  ...
  "description": "Organizations using multiple cloud providers (AWS, Azure, GCP) need to optimize spending by identifying equivalent instances across providers. Finance and infrastructure teams require matched instances with cost savings, performance benchmarks, and actionable optimization recommendations.",
...
```json
{
  ...
  "description": "Cloud instance pricing fluctuates over time due to market conditions and provider changes. Finance teams need historical pricing patterns and multi-period forecasts for budget planning and cost projections.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Organizations evaluating reserved instance (RI) commitments need ROI analysis. Reserved instances require upfront or long-term commitments in exchange for discounts versus on-demand pricing.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Spot instances offer significant discounts (up to 90%) but can be interrupted with short notice. Engineering teams need cost-benefit analysis and risk modeling for fault-tolerant workloads.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud providers charge different prices for identical instance types across regions. Infrastructure teams operating globally need cross-region cost comparisons to optimize placement while considering data transfer and compliance.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Engineering teams need to understand the relationship between instance performance metrics and costs to optimize resource allocation and identify cost-efficient configurations.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud operations teams conduct quarterly reviews to determine which instance families provide the best cost-to-performance ratio for standardization decisions.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Finance teams need to project cloud infrastructure costs for the next fiscal quarter based on historical spending patterns to prepare budgets and identify potential overruns.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Enterprise architecture teams evaluating multi-cloud strategy need to compare current costs with projected costs across AWS, Azure, and GCP for workload distribution decisions.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "CFOs require multi-year financial analysis of cloud investments to evaluate net present value of commitment options (on-demand vs reserved vs savings plans) for capital planning.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud infrastructure teams need to identify overprovisioned, underutilized instances leading to unnecessary spending and right-sizing recommendations.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Finance teams noticing unexpected monthly cloud bill fluctuations need proactive cost anomaly detection before issues escalate.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Organizations running many on-demand instances with consistent usage patterns need reserved instance purchase recommendations to capture up to 70% savings.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Engineering teams want to leverage spot instances for cost savings on fault-tolerant workloads but need interruption risk analysis to ensure acceptable reliability.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Multi-cloud strategy requires understanding equivalent instance offerings across AWS, Azure, and Google Cloud for provider selection and cost-effective workload placement.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud operations teams need to identify optimal instance configurations offering the best balance between cost and performance (pareto frontier).",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud providers regularly deprecate older instance types, forcing migrations. Operations teams need cost impact and usage analysis to support migration planning.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Burstable instances (e.g., AWS T-series) offer savings for variable CPU workloads but excessive bursting can cause credit depletion and throttling. Teams need cost and burst utilization analysis.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "GPU instances are among the most expensive cloud resources for ML, rendering, and compute workloads. Teams need cost and utilization analysis for optimization.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Storage costs accumulate from block volumes, snapshots, and archives. Organizations often have unused volumes, excessive snapshots, and improper tiering leading to unnecessary spending.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud infrastructure teams need network cost analysis across instances to identify high-bandwidth consumers and optimize data transfer expenses.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Finance teams require cost allocation reports to attribute cloud expenses to departments, cost centers, and projects for budget tracking and chargeback.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud operations teams need visibility into complete cost lifecycle of instances from creation to termination for TCO understanding and retirement optimization.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "FinOps teams need to quantify cost optimization opportunities by scoring instances on utilization, rightsizing potential, reserved coverage, and idle resource identification.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud architecture teams evaluating workload migrations need a side-by-side comparison matrix of instance types for cost-effectiveness, performance, and operational metrics.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud infrastructure involves dependency chains (e.g., app servers depending on databases). Teams need recursive dependency analysis to trace relationships and aggregate costs across the tree.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Organizations purchase reserved instances for cost reduction but unused or underutilized reserved capacity represents wasted commitments. Teams need utilization analysis.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Spot instances offer significant savings but come with price volatility and availability risks. Teams need price volatility analysis to quantify fluctuations and assess cost-effectiveness.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Cloud providers charge different rates for identical instance types across regions. Multi-region deployments need regional cost differences for workload placement and migration decisions.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Query results with detailed cost  metrics",
  "description": "Executives and finance teams require a holistic view of cloud spending synthesizing total expenditure, trends, service breakdowns, regional distribution, anomalies, forecasts, and efficiency metrics.",
