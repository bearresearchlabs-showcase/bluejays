#!/usr/bin/env python3
"""
Execution testing script for db-14 queries - PostgreSQL Only
...
def main():
    ...
    print("="*70)
    print("Execution Testing for db-14 queries.md - PostgreSQL Only")
    print("="*70)
    ...
    if not os.environ.get('POSTGRES_DB'):
        os.environ['POSTGRES_DB'] = os.environ.get('PG_DATABASE', 'db14')
    ...
    tester = DatabaseTester('db-14', 14)
