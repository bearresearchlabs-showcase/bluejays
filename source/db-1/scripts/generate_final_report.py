...
def main():
    ...
    report = {
        ...
        'summary': {
            ...
            'execution_testing_status': 'PASS' if execution_results.get('postgresql', {}).get('available') else 'PARTIAL'
        },
    ...
    if len(available_dbs) < 1:
        report['notes'].append('Syntax validation: PostgreSQL connection not available. Set PG_* env vars for full validation.')
