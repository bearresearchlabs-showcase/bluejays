...
```json
{
  ...
  "description": "Fleet operators monitor ADS-B telemetry to track aircraft altitude over time for anomaly detection and maintenance planning. Each aircraft has a unique ICAO 24-bit transponder hex code; altitude is in feet. Daily summaries help detect sensor drift, flight envelope excursions, or operational issues.",
...
```json
{
  ...
  "description": "Flight analysts compare altitude behavior across groundspeed ranges (knots) to see if cruise vs climb/descent phases show different patterns. This supports flight profile optimization and speed-related anomaly detection.",
...
```json
{
  ...
  "description": "Fleet managers produce monthly reports to track long-term altitude trends per aircraft and identify seasonal patterns. Monthly aggregation smooths daily noise and reveals gradual shifts in flight behavior.",
...
```json
{
  ...
  "description": "Operations teams want to know whether certain speed regimes (cruise vs climb/descent) exhibit more altitude anomalies or different trend behaviors. Daily breakdowns by speed help pinpoint sensor issues or airspace constraints.",
...
```json
{
  ...
  "description": "Fleet analysts compare altitude variability and trend direction across aircraft weekly to identify units needing attention. Standard deviation indicates stability; combining it with trend counts helps prioritize investigations.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and speed",
  "description": "Flight operations analysts monitor daily altitude patterns across speed regimes to identify instrumentation issues, unusual weather, or non-standard flight profiles. Speed buckets isolate climb, cruise, and descent behavior.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and hex",
  "description": "Fleet managers need monthly altitude summaries per aircraft to compare operational profiles, assess fleet consistency, and identify aircraft with unusual distributions or high cumulative activity requiring maintenance review.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and speed",
  "description": "Safety analysts detect rapid altitude changes between consecutive readings per aircraft. Sudden climbs or descents may indicate turbulence, emergency maneuvers, or data quality issues. Time gaps between readings assess data continuity.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and hex",
  "description": "Quality assurance teams monitor altitude within specific speed regimes to detect anomalies (e.g., unexpected altitude holds at high speed, erratic changes during approach). Statistical outliers help flag data for manual review.",
...
```json
{
  ...
  "description": "Maintenance planners prioritize aircraft inspections using recency (how recently active) and frequency (how often in data) as key indicators. Aircraft that are both frequently active and recently observed may need earlier scheduling.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and hex",
  "description": "Aviation analysts need to understand how altitude behavior varies across speed regimes over time, similar to cohort analysis. This identifies performance patterns and anomalies in flight operations.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and speed",
  "description": "Flight safety analysts detect sudden altitude changes that may indicate emergency maneuvers, equipment issues, or unusual flight patterns. Tracking both altitude changes (first derivative) and their acceleration (second derivative) helps identify critical events.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and hex",
  "description": "Aviation operations teams benchmark altitude patterns across speed regimes (cruise, climb, descent) to see if aircraft maintain appropriate altitude profiles. Cross-category comparison identifies operational inefficiencies or safety concerns.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and speed",
  "description": "Aircraft maintenance and flight operations analysts identify underlying altitude trends by filtering short-term noise. Raw readings can be erratic due to weather, ATC, and normal operations; smoothing techniques enable trend detection.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and hex",
  "description": "Air traffic management and capacity planning teams identify when aircraft in different speed categories reach peak altitudes each day. Peak period understanding helps optimize airspace utilization and predict congestion.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and speed",
  "description": "Maintenance planning prioritizes aircraft for scheduled inspections based on total flight activity over time. LTV-style metrics rank aircraft by cumulative altitude exposure to allocate maintenance resources.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and hex",
  "description": "Fleet operations need to correlate altitude with temporal patterns (hour of day, day of week) to identify time-of-day effects. This supports shift planning and operational scheduling.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and speed",
  "description": "Operations analysts segment altitude behavior by speed and time period to identify regime-specific patterns. Comparing climb vs cruise vs descent phases helps optimize flight profiles.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and hex",
  "description": "Maintenance teams track altitude volatility (standard deviation) and trend consistency across aircraft. High volatility may indicate equipment issues or unusual flight profiles.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and speed",
  "description": "Fleet managers compare altitude distributions across aircraft and speed categories to identify outliers. Percentile-based benchmarking supports fleet-wide consistency assessment.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and hex",
  "description": "Operations teams need rolling-window altitude metrics to smooth noise and reveal trends. Moving averages and cumulative sums help assess operational patterns over time.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and speed",
  "description": "Flight analysts segment altitude by speed bucket and time period to identify regime-specific anomalies. Speed-temporal segmentation supports targeted investigations.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and hex",
  "description": "Maintenance planners use altitude quartiles and distribution shape to assess aircraft behavior. Quartile analysis reveals central tendency and spread without assuming normality.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and speed",
  "description": "Operations teams correlate altitude with temporal features (hour, day of week) to detect time-of-day patterns. This supports shift-based operational planning.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and hex",
  "description": "Fleet analysts need cross-aircraft and cross-speed altitude comparisons. Percentile rankings and distribution metrics enable fleet-wide benchmarking.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and speed",
  "description": "Safety analysts track altitude change rates (first derivative) and acceleration (second derivative) to detect critical events. Rate-of-change metrics support early warning systems.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and hex",
  "description": "Operations teams segment altitude by speed and aggregate by time period to identify regime-specific trends. Speed-temporal aggregation supports operational optimization.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by month and speed",
  "description": "Maintenance planners use cumulative altitude exposure and activity metrics to prioritize inspections. LTV-style and recency-frequency metrics support resource allocation.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by day and hex",
  "description": "Fleet managers need altitude distribution metrics (quartiles, percentiles) across aircraft and speed categories. Distribution analysis supports consistency and outlier detection.",
...
```json
{
  ...
  "schema_context": {},
  "expected_output": "Aggregated metrics grouped by week and speed",
  "description": "Operations analysts correlate altitude with temporal and speed dimensions to identify multi-dimensional patterns. Cross-dimensional analysis supports comprehensive operational insights.",
