...
```yaml
db_id: db-10
domain: marketing, campaigns, analytics
source: synthetic
license_type: Open
license_cost: $0
tables: 12
...
```text
This database supports analytics for marketing intelligence: campaigns, channels, conversions, and attribution.
```

## Use Case

```text
Target use cases: campaign analytics, channel ROI, conversion funnels, attribution dashboards.
```

## Business Value

```text
Enables marketing teams to optimize spend, measure ROI, and improve conversion ($1M+ ARR).
```
...
```text
Campaigns, channels, conversions, attribution. Marketing funnel metrics.
```
