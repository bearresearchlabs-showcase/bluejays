...
1. [Query 1: Can you show me a multi-provider cost-performance analysis that matches equivalent instances across cloud providers and includes cross-cloud optimization recommendations?](#query-1)
    ...
    - *What it does:* Situation: Our organization uses multiple cloud providers (AWS, Azure, GCP) and needs to optimize cloud spending by identifying equivalent instances a...
...
2. [Query 2: Can you provide a historical pricing trend analysis with multi-period forecasting for our cloud instances?](#query-2)
    ...
    - *What it does:* Situation: Cloud instance pricing fluctuates over time due to market conditions, new instance types, and provider pricing changes. Our finance team ne...
...
3. [Query 3: Can you analyze the ROI of our reserved instances with multi-year cost projections?](#query-3)
    ...
    - *What it does:* Situation: Our organization is evaluating reserved instance (RI) commitments to reduce cloud costs. Reserved instances require upfront payment or long...
    - *Business Value:* Query results with detailed cost  metrics
...
4. [Query 4: Can you provide a cost-benefit analysis of spot instances including risk modeling for interruptions?](#query-4)
    ...
    - *What it does:* Situation: Spot instances offer significant discounts (up to 90%) compared to on-demand pricing but can be interrupted with short notice when cloud pr...
    - *Business Value:* Query results with detailed cost  metrics
...
5. [Query 5: Can you show me regional pricing optimization opportunities with detailed cross-region cost comparisons?](#query-5)
    ...
    - *What it does:* Situation: Cloud providers charge different prices for identical instance types across geographic regions due to varying operational costs, energy pri...
    - *Business Value:* Query results with detailed cost  metrics
...
6. [Query 6: Can you show me a performance-cost correlation analysis using statistical modeling techniques?](#query-6)
    ...
    - *What it does:* Situation: The engineering team managing cloud infrastructure needs to understand the relationship between instance performance metrics and their asso...
    - *Business Value:* Query results with detailed cost  metrics
...
7. [Query 7: Can you provide a cost efficiency ranking for different instance families?](#query-7)
    ...
    - *What it does:* Situation: The cloud operations team is conducting a quarterly review to determine which instance families provide the best cost-to-performance ratio,...
    - *Business Value:* Query results with detailed cost  metrics
...
8. [Query 8: Can you generate a cost forecast using time-series analysis on our cloud spending?](#query-8)
    ...
    - *What it does:* Situation: The finance team needs to project cloud infrastructure costs for the next fiscal quarter to prepare accurate budgets and identify potential...
    - *Business Value:* Query results with detailed cost  metrics
...
9. [Query 9: Can you provide a cost analysis for migrating workloads across multiple cloud providers?](#query-9)
    ...
    - *What it does:* Situation: The enterprise architecture team is evaluating a multi-cloud strategy and needs to compare current costs with projected costs across AWS, A...
    - *Business Value:* Query results with detailed cost  metrics
...
10. [Query 10: Can you show me long-term cost projections using discounted cash flow analysis?](#query-10)
    ...
    - *What it does:* Situation: The CFO requires a multi-year financial analysis of cloud infrastructure investments to evaluate the net present value of different commitm...
    - *Business Value:* Query results with detailed cost  metrics
...
11. [Query 11: Show me instance right-sizing recommendations to optimize our cloud spending.](#query-11)
    ...
    - *What it does:* Situation: Our cloud infrastructure team needs to identify overprovisioned instances that are underutilized, leading to unnecessary cloud spending. Th...
    - *Business Value:* Query results with detailed cost  metrics
...
12. [Query 12: Show me cost anomaly detection results with statistical analysis to identify unusual spending patterns.](#query-12)
    ...
    - *What it does:* Situation: The finance team has noticed unexpected fluctuations in monthly cloud bills and needs to proactively detect cost anomalies before they esca...
    - *Business Value:* Query results with detailed cost  metrics
...
13. [Query 13: Show me reserved instance purchase optimization recommendations to maximize savings.](#query-13)
    ...
    - *What it does:* Situation: Our organization runs many on-demand instances with consistent long-term usage patterns, but we're not taking advantage of reserved instanc...
    - *Business Value:* Query results with detailed cost  metrics
...
14. [Query 14: Show me spot instance interruption risk analysis to balance cost savings with reliability.](#query-14)
    ...
    - *What it does:* Situation: The engineering team wants to leverage spot instances for cost savings (up to 90% discount) on fault-tolerant workloads, but needs to under...
    - *Business Value:* Query results with detailed cost  metrics
...
15. [Query 15: Show me cross-provider instance matching to compare equivalent offerings across cloud platforms.](#query-15)
    ...
    - *What it does:* Situation: Our multi-cloud strategy requires understanding equivalent instance offerings across AWS, Azure, and Google Cloud to make informed provider...
    - *Business Value:* Query results with detailed cost  metrics
...
16. [Query 16: Can you help me analyze the cost-performance pareto frontier across our cloud instances?](#query-16)
    ...
    - *What it does:* Situation: The cloud operations team needs to identify optimal instance configurations that offer the best balance between cost and performance. Under...
    - *Business Value:* Query results with detailed cost  metrics
...
17. [Query 17: Can you show me the impact analysis for instances that are approaching deprecation?](#query-17)
    ...
    - *What it does:* Situation: Cloud providers regularly deprecate older instance types, forcing migrations to newer alternatives. The infrastructure team needs to unders...
    - *Business Value:* Query results with detailed cost  metrics
...
18. [Query 18: I'd like to see a cost analysis specifically for our burstable instance usage.](#query-18)
    ...
    - *What it does:* Situation: Burstable instances (such as T-series in AWS) offer cost savings for workloads with variable CPU usage by providing baseline performance wi...
    - *Business Value:* Query results with detailed cost  metrics
...
19. [Query 19: Can you provide a cost analysis for all GPU-enabled instances in our infrastructure?](#query-19)
    ...
    - *What it does:* Situation: GPU instances are among the most expensive cloud resources, used for machine learning, rendering, and compute-intensive workloads. Given th...
    - *Business Value:* Query results with detailed cost  metrics
...
20. [Query 20: I need to analyze our storage costs to find optimization opportunities.](#query-20)
    ...
    - *What it does:* Situation: Cloud storage costs accumulate from multiple sources including block storage volumes, snapshots, and archived data. Over time, organization...
    - *Business Value:* Query results with detailed cost  metrics
...
21. [Query 21: Can you show me a network cost analysis for our cloud infrastructure?](#query-21)
    ...
    - *What it does:* Situation: Our Cloud Infrastructure team needs to analyze network-related costs across all cloud instances to identify high-bandwidth consumers and op...
    - *Business Value:* Query results with detailed cost  metrics
...
22. [Query 22: Can you provide a cost allocation analysis breaking down expenses by department and project?](#query-22)
    ...
    - *What it does:* Situation: The Finance team requires a comprehensive cost allocation report to accurately attribute cloud infrastructure expenses to specific departme...
    - *Business Value:* Query results with detailed cost  metrics
...
23. [Query 23: Can you analyze the lifecycle costs of our cloud instances from creation to termination?](#query-23)
    ...
    - *What it does:* Situation: The Cloud Operations team needs visibility into the complete cost lifecycle of cloud instances to understand total cost of ownership, ident...
    - *Business Value:* Query results with detailed cost  metrics
...
24. [Query 24: Can you calculate cost optimization scores for our cloud infrastructure?](#query-24)
    ...
    - *What it does:* Situation: The FinOps team needs to quantify cost optimization opportunities across the cloud infrastructure by scoring each instance and resource bas...
    - *Business Value:* Query results with detailed cost  metrics
...
25. [Query 25: Can you generate a comparison matrix showing how different instance types stack up against each other?](#query-25)
    ...
    - *What it does:* Situation: The Cloud Architecture team is evaluating different instance types for upcoming workload migrations and needs a side-by-side comparison mat...
    - *Business Value:* Query results with detailed cost  metrics
...
26. [Query 26: Can you show me a recursive instance dependency graph analysis?](#query-26)
    ...
    - *What it does:* Situation: In the Cloud Instance Cost domain, cloud infrastructure often involves complex dependency chains where instances depend on other instances...
    - *Business Value:* Query results with detailed cost  metrics
...
27. [Query 27: Can you show me a reserved instance utilization analysis?](#query-27)
    ...
    - *What it does:* Situation: In the Cloud Instance Cost domain, organizations purchase reserved instances to reduce cloud costs by committing to long-term capacity, but...
    - *Business Value:* Query results with detailed cost  metrics
...
28. [Query 28: Can you show me a spot instance price volatility analysis?](#query-28)
    ...
    - *What it does:* Situation: In the Cloud Instance Cost domain, spot instances offer significant cost savings compared to on-demand pricing but come with price volatili...
    - *Business Value:* Query results with detailed cost  metrics
...
29. [Query 29: Can you show me a cross-region cost comparison?](#query-29)
    ...
    - *What it does:* Situation: In the Cloud Instance Cost domain, cloud providers charge different rates for identical instance types across geographic regions due to var...
    - *Business Value:* Query results with detailed cost  metrics
...
30. [Query 30: Can you show me a comprehensive cost dashboard?](#query-30)
    ...
    - *What it does:* Situation: In the Cloud Instance Cost domain, executives and finance teams require a holistic view of cloud spending that synthesizes multiple cost di...
    - *Business Value:* Query results with detailed cost  metrics
...
**Description:** Situation: Cloud providers regularly deprecate older instance types, forcing migrations to newer alternatives. The infrastructure team needs to understand the financial and operational impact of upcoming instance deprecations to plan migrations, budget for potential cost changes, and minimize service disruption. Task: Analyze the cost impact and usage patterns of instances facing deprecation to support migration planning. Action: The query filters instances marked as deprecated or with upcoming deprecation dates, joins with costs and usage tables, groups by instance family and deprecation timeline, computes current spend and usage volumes, uses window functions to calculate migration costs and compare pricing with recommended replacement instance types, and aggregates by department or project to identify affected teams. Handles edge cases for instances without clear replacement mappings. Result: Returns a comprehensive view of at-risk instances including current costs, usage levels, re
