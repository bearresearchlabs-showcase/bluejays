#!/usr/bin/env python3
"""
Streamlit Dashboard for DB-7: Maritime Shipping Intelligence
...
# Page configuration
st.set_page_config(
    page_title=f"DB-7: Maritime Shipping Intelligence",
    page_icon="📊",
    layout="wide",
...
def find_queries_file():
    ...
    for search_path in search_paths:
        ...
        if queries_file:
            ...
            if db_dir_candidate.name == 'db-7':
                return queries_file
    
    # Fallback
    return Path('/workspace/client/db/db-7') / 'queries' / 'queries.json'
...
def main():
    ...
    # Header
    st.markdown(f'<div class="main-header">DB-7: Maritime Shipping Intelligence</div>', unsafe_allow_html=True)
