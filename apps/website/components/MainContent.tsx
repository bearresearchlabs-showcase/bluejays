          ...
          <Box component="section" id="overview">
            <Stack spacing={4}>
              <Box component="header">
                <Typography variant="h1">Database Documentation</Typography>
              ...
              <Paper elevation={1} style={{ padding: 'var(--spacing-6)' }}>
                <Stack spacing={2}>
                  ...
                  <Typography variant="body1">
                    <strong>Documentation:</strong> Schema, 30 complex SQL queries with business context, and usage instructions per database.
                  </Typography>
                </Stack>
              </Paper>
